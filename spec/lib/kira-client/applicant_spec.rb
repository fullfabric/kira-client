describe KiraClient::Applicant do
  ...
  context 'interview' do
    ...
    let!( :service ) { KiraClient::Applicant.new(interview_id, token) }
    ...
    context 'creating an applicant' do
      ...
      context 'invalid email' do
        ...
        it 'raises an exception' do
          ...
          expect{ service.create(applicant) }.to raise_error(KiraClient::Error)
